...
import { CreatePisoComponent } from './create-piso.component';
...
describe('CreatePisoComponent', () => {
  let component: CreatePisoComponent;
  let fixture: ComponentFixture<CreatePisoComponent>;
  let location: Location;
  let httpRequestsService: HttpRequestsService;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [CreatePisoComponent],
    ...
    fixture = TestBed.createComponent(CreatePisoComponent);
  ...
  it('should create piso', fakeAsync(() => {
    ...
    component.createPiso("123453","1","descricao");
