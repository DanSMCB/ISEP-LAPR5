...
import Orientation from "./thumb_raiser_files/orientation.js";
import ThumbRaiser from "./thumb_raiser_files/thumb_raiser.js";
@Component({
    ...
    this.animate();
         ...
         initialize() {
            ...
            this.thumbRaiser = new ThumbRaiser(
                {canvas: this.canvas}, // General Parameters
                {
                    enabled: true,
                    introductionClips: [
                        {
