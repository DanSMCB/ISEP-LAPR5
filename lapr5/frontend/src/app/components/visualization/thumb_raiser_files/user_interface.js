...
export default class UserInterface extends GUI {
    constructor(thumbRaiser) {
        ...
        //Create the Buildin Floor selection Folder
        const floorFolder = this.addFolder("Building Floor");
        floorFolder.domElement.style.fontSize = fontSize;
        const floorsParameters = { name: "Select Building Floor that you want to see"};
        const floorsOptions = ["Edificio_A_Piso_1","Edificio_A_Piso_2","Edificio_B_Piso_1","Edificio_B_Piso_2",
        "Edificio_B_Piso_3","Edificio_C_Piso_1","Edificio_C_Piso_2","Edificio_C_Piso_3","Edificio_C_Piso_4","Edificio_D_Piso_1","Edificio_D_Piso_2","Edificio_D_Piso_3"];
        
        
        floorFolder.add(floorsParameters, "name").options(floorsOptions).onChange(name => thumbRaiser.viewBuildingFloor(name));
        floorFolder.close();
